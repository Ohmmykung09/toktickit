...
| API-05 | Security/API | AC-04, AC-05 | Cross-requester Ticket and Attachment access | Same safe not-found response; no leakage | `server/tests/lab-03/authorization.api.test.ts` | Passed on Issue #29 branch |
